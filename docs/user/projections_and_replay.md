...
```elixir
timeline = Jido.Conversation.Projections.timeline("conv-123")
```
...
```elixir
timeline =
  Jido.Conversation.Projections.timeline("conv-123",
...
```elixir
llm_context = Jido.Conversation.Projections.llm_context("conv-123")
```
...
```elixir
llm_context =
  Jido.Conversation.Projections.llm_context("conv-123",
    include_deltas: true,
