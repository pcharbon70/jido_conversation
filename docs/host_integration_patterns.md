...
Expose `Jido.Conversation.Health.status/0` through the host application's health route.
...
Poll `Jido.Conversation.Telemetry.snapshot/0` on a short interval and forward to
