...
- Post-phase hardening complete:
  ...
  - non-stream provider non-retryable failed-payload parity hardening
  - stream provider non-retryable failed-payload parity hardening
  - non-stream retry-progress payload parity hardening across retryable categories
  - stream retry-progress payload parity hardening across retryable categories
  - telemetry retry-category precedence/fallback parity hardening
  - effect-manager LLM retry lifecycle payload parity hardening
  - effect-manager LLM non-stream retry lifecycle payload parity hardening
  - effect-manager LLM non-stream non-retry lifecycle payload parity hardening
  - effect-manager LLM stream non-retry lifecycle payload parity hardening
  - effect-manager LLM stream retry attempt-cardinality and failed-telemetry parity hardening
  - effect-manager LLM non-stream retry attempt-cardinality and failed-telemetry parity hardening
  - effect-manager LLM stream retry-attempt-start lifecycle parity hardening
  - effect-manager LLM non-stream retry-attempt-start lifecycle parity hardening
  - effect-manager LLM cancel lifecycle payload and telemetry parity hardening
  - effect-manager LLM cancel-without-context lifecycle and telemetry parity hardening
  - effect-manager LLM cancel-failed lifecycle and telemetry parity hardening
  - effect-manager LLM cancel-failed attribution payload and backend lifecycle telemetry parity hardening
  - effect-manager LLM explicit cancel cause-link lifecycle tracing parity hardening
  ...
  - effect-manager harness baseline cancel-not-available parity hardening
  - effect-manager harness baseline cancel-failed parity hardening
  - effect-manager harness cancel-ok cause-link parity hardening
  - effect-manager harness cancel-ok invalid-cause fallback parity hardening
  - effect-manager harness cancel-not-available cause-link parity hardening
  - effect-manager harness cancel-not-available invalid-cause fallback parity hardening
  - effect-manager harness cancel-failed cause-link parity hardening
  - effect-manager harness cancel-failed invalid-cause fallback parity hardening
  - effect-manager jido_ai cancel-failed invalid-cause coverage consolidation
  - effect-manager jido_ai baseline cancel-ok parity hardening
